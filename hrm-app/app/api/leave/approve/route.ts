...
import { leaveApproveSchema } from '@/lib/validations/leave';
...
export async function POST(req: NextRequest) {
  ...
  const parsed = leaveApproveSchema.safeParse(body);
  ...
  void (async () => {
    try {
      ...
      const { data: r } = await admin
        ...
        .select('employee_id, start_date, end_date, total_days, leave_type_id')
